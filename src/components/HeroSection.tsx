...
export default function HeroSection() {
  return (
    ...
    >
      {/* Animated background circles with enhanced visibility */}
      <motion.div
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.5, 0.3],
      ...
      <motion.div
        ...
        className="absolute top-40 right-20 w-80 h-80 bg-cyan-600 rounded-full blur-3xl"
      />
      <motion.div
        animate={{
          scale: [1, 1.3, 1],
        ...
        className="absolute bottom-20 left-1/2 w-64 h-64 bg-pink-600 rounded-full blur-3xl"
      />
