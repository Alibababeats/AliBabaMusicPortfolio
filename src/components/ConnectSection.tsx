...
const socialLinks = [
  {
    name: 'YouTube',
    icon: Youtube,
    url: 'https://www.youtube.com/@AliBabaBeats',
    color: 'hover:bg-pink-500/20 hover:text-pink-400',
  },
  {
    name: 'Instagram',
    icon: Instagram,
    url: 'https://www.instagram.com/prod.alibaba?igsh=em13czE2aHM4cmU4&utm_source=qr',
    color: 'hover:bg-pink-500/20 hover:text-pink-400',
  },
  {
    name: 'TikTok',
    ...
    url: 'https://www.tiktok.com/@ali.baba.habibi?_r=1&_t=ZP-92lOncebVmh',
    color: 'hover:bg-cyan-500/20 hover:text-cyan-400',
  },
  {
    name: 'Email',
    icon: Mail,
    url: 'mailto:ali.salem.skate@gmail.com',
...
export default function ConnectSection() {
  return (
    <section className="pt-20 pb-20 px-4 max-w-4xl mx-auto">
      <motion.h2
